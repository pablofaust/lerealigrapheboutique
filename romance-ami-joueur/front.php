<div class="container formulaire">
	...
	<div class="menu">
		...
		<a href="../home"><div class="logo">
			<div class="logo-img">
					<div style="background-image: url('<?php echo $url ?>romance-ami-joueur/img/logo.png')" ></div>
			</div>
	...
	<h2>L'organisation de votre surprise commence maintenant !</h2>
		...
		<form method="post">
			...
			<div class="container formulaire-cadre">
				...
				<input type="text" name="ville-client" id="ville" placeholder="29/03/2017"><br><br><br>

				<label for="ville" class="ville-client">C'est :</label>
				<input type="radio" name="sexe" value="Un homme" checked>Un homme<br>
  				<input type="radio" name="sexe" value="Une femme">Une femme<br><br>

  				<label for="ville" class="ville-client">Intéressé par :</label>

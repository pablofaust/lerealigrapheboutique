<div class="container formulaire">
	...
	<div class="menu">
		...
		<a href="../home"><div class="logo">
			<div class="logo-img">
					<div style="background-image: url('<?php echo $url ?>romance-perso/img/logo.png')" ></div>
			</div>
	...
	<h2>L'organisation de votre surprise commence maintenant !</h2>
		...
		<form method="post">
			...
			<div class="container formulaire-cadre">
				...
				<input type="text" name="ville-client" id="ville" placeholder="pabfaust@gmail.com"><br><br><br>

				<label for="ville" class="ville-client">Vous êtes :</label>
				<input type="radio" name="sexe" value="Un homme" checked>Un homme<br>
  				<input type="radio" name="sexe" value="Une femme">Une femme<br><br>

  				<label for="ville" class="ville-client">Vous cherchez :</label>
				<input type="radio" name="attirance" value="Un homme" checked>Un homme<br>
  				<input type="radio" name="attirance" value="Une femme">Une femme<br>
